...
CREATE TABLE KHOA
(
	MAKHOA char(4) CONSTRAINT PK_KHOA PRIMARY KEY,
	TENKHOA	varchar(40),
...
CREATE TABLE MONHOC
(
	MAMH char(10) CONSTRAINT PK_MH PRIMARY KEY,
	TENMH varchar(40),
	TCLT tinyint,
	TCTH tinyint,
	MAKHOA char(4),
...
ALTER TABLE HOCVIEN
ADD CONSTRAINT CHK_GT_HV CHECK(GIOITINH IN('Nam','Nu'))

ALTER TABLE GIAOVIEN
ADD CONSTRAINT CHK_GT_GV CHECK(GIOITINH IN('Nam','Nu'))

--4. Điểm số của một lần thi có giá trị từ 0 đến 10 và cần lưu đến 2 số lẻ (VD: 6.22).
ALTER TABLE KETQUATHI
ADD CONSTRAINT CHK_DIEM CHECK(DIEM>=0 AND DIEM<=10)

--5. Kết quả thi là “Dat” nếu điểm từ 5 đến 10 và “Khong dat” nếu điểm nhỏ hơn 5.
ALTER TABLE KETQUATHI
ADD CONSTRAINT CHK_KQT CHECK((DIEM BETWEEN 5 AND 10 AND KQUA = 'Dat') OR (DIEM>=0 AND KQUA = 'Khong dat'))
...
ADD CONSTRAINT CHK_HOCKY CHECK (HOCKY>0 AND HOCKY<=3)
...
ALTER TABLE LOP
ADD CONSTRAINT CHK_TRGLOP CHECK(LEFT(TRGLOP,3)=MALOP)
